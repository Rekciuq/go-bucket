...
func (uq *URLQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (uq *URLQuery) FirstIDX(ctx context.Context) string {
...
func (uq *URLQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (uq *URLQuery) OnlyIDX(ctx context.Context) string {
...
func (uq *URLQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (uq *URLQuery) IDsX(ctx context.Context) []string {
	ids, err := uq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (uq *URLQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(url.Table, url.Columns, sqlgraph.NewFieldSpec(url.FieldID, field.TypeString))
	_spec.From = uq.sql
